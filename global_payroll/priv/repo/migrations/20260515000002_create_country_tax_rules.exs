defmodule GlobalPayroll.Repo.Migrations.CreateCountryTaxRules do
  ...
  def change do
    create table(:country_tax_rules, primary_key: false) do
      ...
      # ISO code e.g. "MX", "US", "ES"
      add :country_code, :string, null: false
      add :country_name, :string, null: false
      # e.g. 0.2500 = 25%
      add :income_tax_rate, :decimal, null: false, precision: 5, scale: 4
      # e.g. 0.0650 = 6.5%
      add :social_security_rate, :decimal, null: false, precision: 5, scale: 4
      # e.g. "MXN", "USD", "EUR"
      add :currency, :string, null: false

      # rules are never edited, only inserted
