defmodule GlobalPayrollWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {GlobalPayrollWeb.Layouts, :root}
  ...
  scope "/app" do
    ...
    live "/companies", GlobalPayrollWeb.Live.CompaniesLive
    live "/companies/:id", GlobalPayrollWeb.Live.CompanyShowLive
    live "/runs/:id", GlobalPayrollWeb.Live.RunShowLive
  end
